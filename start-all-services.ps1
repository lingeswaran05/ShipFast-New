...
Start-Svc "Frontend" "." "$env:VITE_API_BASE_URL='http://localhost:8088'; $env:VITE_AUTH_BASE_URL='http://localhost:8088'; $env:VITE_SHIPMENT_BASE_URL='http://localhost:8088'; $env:VITE_OPERATIONS_BASE_URL='http://localhost:8088'; $env:VITE_ADMIN_BASE_URL='http://localhost:8088'; $env:VITE_COMM_BASE_URL='http://localhost:8088'; $env:VITE_REPORTING_BASE_URL='http://localhost:8088'; $env:VITE_ENABLE_OLD_BACKEND_FALLBACK='false'; npm run dev -- --host 0.0.0.0 --port 5173"
